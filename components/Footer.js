    ...
    return (
        <div>
                            ...
                            <div className="col-lg-6">
                                <div className="newsletter-part">
                                    <div className="ft-header">
                                        <h4>Get The Latest ANOYA nft Updates</h4>
                                    </div>
                                    <form action="#">
            ...
            <div className="footer-bottom">
                <div className="container">
                    <p className="text-center py-4 mb-0">All rights reserved &copy; ANOYA.io || Design By: <a
                            href="https://itvision.pro">IT-vision</a>
                    </p>
                </div>
            </div>
        </footer>
